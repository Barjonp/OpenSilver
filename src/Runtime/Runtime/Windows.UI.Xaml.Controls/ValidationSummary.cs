...
#else
using resources = Windows.UI.Xaml.Controls.Data.Input.Resources;
#endif
...
#region Private Methods
        ...
        private void Errors_CollectionChanged(object sender, global::System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            if (e.OldItems != null)
            {
...
#else // BRIDGE
                string key = String.IsNullOrEmpty(inputControl.Name) ? inputControl.GetHashCode().ToString() : inputControl.Name;
#endif
                key += message;
