...
#endif
{
    ...
    [TemplateVisualState(Name = "ValidFocused", GroupName = VisualStates.GroupValidation)]
    [TemplateVisualState(Name = "ValidUnfocused", GroupName = VisualStates.GroupValidation)]
#endif // SL_TOOLKIT
