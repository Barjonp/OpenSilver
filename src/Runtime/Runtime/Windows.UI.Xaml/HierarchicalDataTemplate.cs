...
#endif
{
    ...
    /// <see cref="Controls.HeaderedItemsControl" /> objects,
    /// such as <see cref="Controls.TreeViewItem" />.
    /// </summary>
...
#region public DataTemplate ItemTemplate
        ...
        /// apply to the
        /// <see cref="Controls.ItemsControl.ItemTemplate" />
        /// property on a generated
        /// <see cref="Controls.HeaderedItemsControl" />, such
        /// as a <see cref="Controls.TreeViewItem" />, to
